...
if __name__ == "__main__":
    ...
    train_ds = AnnotatedDataset(train_df, tokenizer=tokenizer, max_seq_len=max_seq_len)
    test_ds = AnnotatedDataset(test_df, tokenizer=tokenizer, max_seq_len=max_seq_len)
